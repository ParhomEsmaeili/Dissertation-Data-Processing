...
def main():
    ucl_data_rgb_dir = os.path.join(os.getcwd(), 'UCL Selected Data', 'edges', 'imgs', 'validation', 'rgbr')
    ucl_data_gt_dir = os.path.join(os.getcwd(), 'UCL Selected Data', 'edges', 'edge_maps', 'validation', 'rgbr')

    endomapper_both_subset_rgb_dir = os.path.join(os.getcwd(), 'EndoMapper Selected Data', 'edges', 'imgs', 'validation', 'rgbr')
    endomapper_both_subset_gt_dir = os.path.join(os.getcwd(), 'EndoMapper Selected Data', 'edges', 'edge_maps', 'validation', 'rgbr')
    endomapper_inpaint_rgb_dir = os.path.join(os.getcwd(), 'EndoMapper Selected Data Inpainted Only', 'edges', 'imgs', 'validation', 'rgbr')
    endomapper_inpaint_gt_dir = os.path.join(os.getcwd(), 'EndoMapper Selected Data Inpainted Only', 'edges', 'edge_maps', 'validation', 'rgbr')
    endomapper_spec_rgb_dir = os.path.join(os.getcwd(), 'EndoMapper Selected Data Rescaled Specularity Only', 'edges', 'imgs', 'validation', 'rgbr')
    endomapper_spec_gt_dir = os.path.join(os.getcwd(), 'EndoMapper Selected Data Rescaled Specularity Only', 'edges', 'edge_maps', 'validation', 'rgbr')

    combined_rgb_output_dir = os.path.join(os.getcwd(), 'Combined Selected Data', 'edges', 'imgs', 'validation', 'rgbr', 'real')
    combined_gt_output_dir = os.path.join(os.getcwd(), 'Combined Selected Data', 'edges', 'edge_maps', 'validation', 'rgbr', 'real')

    combined_with_inpaint_rgb_output_dir = os.path.join(os.getcwd(), 'Combined Selected Data v2', 'edges', 'imgs', 'validation', 'rgbr', 'real')
    combined_with_inpaint_gt_output_dir = os.path.join(os.getcwd(), 'Combined Selected Data v2', 'edges', 'edge_maps', 'validation', 'rgbr', 'real')

    combined_with_respec_rgb_output_dir = os.path.join(os.getcwd(), 'Combined Selected Data v3', 'edges', 'imgs', 'validation', 'rgbr', 'real')
    combined_with_respec_gt_output_dir = os.path.join(os.getcwd(), 'Combined Selected Data v3', 'edges', 'edge_maps', 'validation', 'rgbr', 'real')
